      ...
      let gameResults = data.games.gameData.map((game) => {
        ...
        return (
          <div id={game.gameId} name={game.gameId} key={game.gameId} className="schedule-grid-row row">
            {isCompositeSchedule ? <div className="schedule-grid-item grid-sport flexcontainer"><p className="rotate">{game.sport}</p></div> : ""}
            ...
            <div className="schedule-grid-item grid-game-info">
              ...
              <p className="schedule-opponent">{isHomeGame ? <span className="home-away home-game">vs</span> : <span className="home-away away-game">at</span>}
